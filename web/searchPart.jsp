<%-- 
    Document   : searchPart
    Created on : Apr 17, 2022, 9:38:48 PM
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Search or Remove Participant</title>
        <%@page import="java.sql.*;" %>
    </head>
    <body>
        <h1>Search or Remove Result</h1>
        <%
                try {
                ...
                ResultSet rs = stmt.executeQuery("select * from conference.registration where first_name='"+request.getParameter("partName")+"'");
