...
<html>
    ...
    <body>
        ...
        <%
            if(request.getParameter("choice")=="all"){
            ...
            } else if(request.getParameter("choice") == "Student"){
                ...
                try {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/conference?autoReconnect=true&useSSL=false", "root", "1234");
                    Statement stmt = con.createStatement();
                    ResultSet rs = stmt.executeQuery("select * from conference.registration where partiType = Student");
            ...
            }else if(request.getParameter("choice") == "Normal"){
                //String type = request.getParameter("choice");
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/conference?autoReconnect=true&useSSL=false", "root", "1234");
                    Statement stmt = con.createStatement();
                    ResultSet rs = stmt.executeQuery("select * from conference.registration where partiType = Normal");
